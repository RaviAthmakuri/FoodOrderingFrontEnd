...
class Details extends Component {
  ...
  componentDidMount() {
    ...
    itemRemoveButtonClickHandler =  (item) => {
        let cartItems = this.state.cartItems;
                    ...
                    <Card className={classes.myCart}>
                        ...
                        <CardContent className={classes.cardContent}>
                            ...
                            <div className="cart-menu-item-container" key={cartItem.id}>
                                ...
                                <IconButton className={classes.cartItemButton} id="minus-button" aria-label="remove" onClick = {() => this.itemRemoveButtonClickHandler(cartItem)} >
                                ...
                                <IconButton className={classes.cartItemButton} aria-label="add"  onClick = {() => this.cartButtonClickHandler(cartItem)}>
